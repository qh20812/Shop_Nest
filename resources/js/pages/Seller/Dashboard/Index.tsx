...
export default function Index() {
  ...
  const stockAlerts = props.stockAlerts ?? 0;
                ...
                <div key={product.product_id} className="product-item">
                  ...
                  <div className="product-info">
                    ...
                    <div className="product-stats">
                      <span className="quantity">{product.total_quantity} {t('sold')}</span>
                ...
                <>
                  <div className="alert-item warning">
                    ...
                    <div className="alert-content">
                      ...
                      <p>{t('You have')} {stockAlerts} {t('products with low stock')}</p>
                    </div>
                  </div>
                      ...
                      <td>
                        <div className="order-products">
                          ...
                          {order.items && order.items.length > 2 && (
                            <span className="more-items">+{order.items.length - 2} {t('more')}</span>
                          )}
                        </div>
                      </td>
                    </tr>
        ...
        <div className="performance">
          ...
          <div className="metrics-grid">
            ...
            <div className="metric-card">
              ...
              <div className="metric-content">
                <h4>{t('Top Product')}</h4>
                <p className="metric-value top-product">
                  {shopStats.top_selling_product || t('No data')}
                </p>
              </div>
            </div>
            ...
            <div className="metric-card">
              ...
              <div className="metric-content">
                ...
                <p className="metric-value alert-count">{stockAlerts}</p>
              </div>
            </div>
          </div>
        </div>
